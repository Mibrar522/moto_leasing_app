...
const CUSTOMER_FIELD_ACCESS = [
    ['FEAT_CUSTOMER_FIELD_ASSIGNED_DEALER', 'Customers Field: Assigned Dealer'],
    ['FEAT_CUSTOMER_FIELD_CREATED_BY', 'Customers Field: Created By'],
    ['FEAT_CUSTOMER_FIELD_FULL_NAME', 'Customers Field: Full Name'],
    ['FEAT_CUSTOMER_FIELD_FATHER_NAME', 'Customers Field: Father Name'],
    ['FEAT_CUSTOMER_FIELD_DATE_OF_BIRTH', 'Customers Field: Date Of Birth'],
    ['FEAT_CUSTOMER_FIELD_GENDER', 'Customers Field: Gender'],
    ['FEAT_CUSTOMER_FIELD_DOCUMENT_TYPE', 'Customers Field: Document Type'],
    ['FEAT_CUSTOMER_FIELD_CNIC_PASSPORT_NUMBER', 'Customers Field: CNIC / Passport Number'],
    ['FEAT_CUSTOMER_FIELD_CNIC_FRONT_UPLOAD', 'Customers Field: CNIC Front Upload'],
    ['FEAT_CUSTOMER_FIELD_CNIC_BACK_UPLOAD', 'Customers Field: CNIC Back Upload'],
    ['FEAT_CUSTOMER_FIELD_CONTACT_EMAIL', 'Customers Field: Contact Email'],
    ['FEAT_CUSTOMER_FIELD_CONTACT_PHONE', 'Customers Field: Contact Phone'],
    ['FEAT_CUSTOMER_FIELD_COUNTRY', 'Customers Field: Country'],
    ['FEAT_CUSTOMER_FIELD_ADDRESS', 'Customers Field: Address'],
    ['FEAT_CUSTOMER_FIELD_OCR_EXTRACTED_NAME', 'Customers Field: OCR Extracted Name'],
    ['FEAT_CUSTOMER_FIELD_OCR_SCAN_TEXT', 'Customers Field: OCR Scan Text'],
    ['FEAT_CUSTOMER_FIELD_FINGERPRINT_SCANNER_OUTPUT', 'Customers Field: Fingerprint Scanner Output'],
    ['FEAT_CUSTOMER_FIELD_SCANNER_DEVICE', 'Customers Field: Scanner Device'],
    ['FEAT_CUSTOMER_FIELD_SCAN_QUALITY', 'Customers Field: Scan Quality'],
    ['FEAT_CUSTOMER_FIELD_FINGERPRINT_STATUS', 'Customers Field: Fingerprint Status'],
    ['FEAT_CUSTOMER_FIELD_BIOMETRIC_HASH', 'Customers Field: Biometric Hash'],
    ['FEAT_CUSTOMER_FIELD_BIOMETRIC_THUMB_URL', 'Customers Field: Biometric Thumb URL'],
    ['FEAT_CUSTOMER_FIELD_THUMB_UPLOAD', 'Customers Field: Thumb Upload'],
    ['FEAT_CUSTOMER_FIELD_SIGNATURE_URL', 'Customers Field: Signature URL'],
    ['FEAT_CUSTOMER_FIELD_SIGNATURE_UPLOAD', 'Customers Field: Signature Upload'],
];

const SALES_FIELD_ACCESS = [
    ['FEAT_SALES_FIELD_CUSTOMER', 'Sales Field: Customer'],
    ['FEAT_SALES_FIELD_AVAILABLE_STOCK', 'Sales Field: Available Stock'],
    ['FEAT_SALES_FIELD_SALE_MODE', 'Sales Field: Sale Mode'],
    ['FEAT_SALES_FIELD_AGREEMENT_NUMBER', 'Sales Field: Agreement Number'],
    ['FEAT_SALES_FIELD_AGREEMENT_DATE', 'Sales Field: Agreement Date'],
    ['FEAT_SALES_FIELD_PURCHASE_DATE', 'Sales Field: Purchase Date'],
    ['FEAT_SALES_FIELD_ACTUAL_PRICE', 'Sales Field: Actual Price'],
    ['FEAT_SALES_FIELD_PRINT_ACTUAL_PRICE_ON_INVOICE', 'Sales Field: Print Actual Price on Invoice'],
    ['FEAT_SALES_FIELD_PURCHASE_PRICE', 'Sales Field: Purchase Price'],
    ['FEAT_SALES_FIELD_SELLING_PRICE', 'Sales Field: Selling Price'],
    ['FEAT_SALES_FIELD_TOTAL_PRICE', 'Sales Field: Total Price'],
    ['FEAT_SALES_FIELD_MARGIN_PERCENT', 'Sales Field: Margin %'],
    ['FEAT_SALES_FIELD_MARGIN_VALUE', 'Sales Field: Margin Value'],
    ['FEAT_SALES_FIELD_MARKUP_PERCENTAGE', 'Sales Field: Markup Percentage'],
    ['FEAT_SALES_FIELD_DOWN_PAYMENT', 'Sales Field: Down Payment'],
    ['FEAT_SALES_FIELD_MONTHLY_INSTALLMENT', 'Sales Field: Monthly Installment'],
    ['FEAT_SALES_FIELD_WITNESS_NAME', 'Sales Field: Witness Name'],
    ['FEAT_SALES_FIELD_WITNESS_CNIC', 'Sales Field: Witness CNIC'],
    ['FEAT_SALES_FIELD_WITNESS_2_NAME', 'Sales Field: Witness 2 Name'],
    ['FEAT_SALES_FIELD_WITNESS_2_CNIC', 'Sales Field: Witness 2 CNIC'],
    ['FEAT_SALES_FIELD_AGREEMENT_PDF', 'Sales Field: Agreement PDF'],
    ['FEAT_SALES_FIELD_UPLOADED_AGREEMENT_URL', 'Sales Field: Uploaded Agreement URL'],
    ['FEAT_SALES_FIELD_DEALER_SIGNATURE_UPLOAD', 'Sales Field: Dealer Signature Upload'],
    ['FEAT_SALES_FIELD_DEALER_SIGNATURE_URL', 'Sales Field: Dealer Signature URL'],
    ['FEAT_SALES_FIELD_AUTHORIZED_SIGNATURE_UPLOAD', 'Sales Field: Authorized Signature Upload'],
    ['FEAT_SALES_FIELD_AUTHORIZED_SIGNATURE_URL', 'Sales Field: Authorized Signature URL'],
    ['FEAT_SALES_FIELD_CUSTOMER_CNIC_FRONT_UPLOAD', 'Sales Field: Customer CNIC Front Upload'],
    ['FEAT_SALES_FIELD_CUSTOMER_CNIC_FRONT_URL', 'Sales Field: Customer CNIC Front URL'],
    ['FEAT_SALES_FIELD_CUSTOMER_CNIC_BACK_UPLOAD', 'Sales Field: Customer CNIC Back Upload'],
    ['FEAT_SALES_FIELD_CUSTOMER_CNIC_BACK_URL', 'Sales Field: Customer CNIC Back URL'],
    ['FEAT_SALES_FIELD_BANK_CHECK_UPLOAD', 'Sales Field: Bank Check Upload'],
    ['FEAT_SALES_FIELD_UPLOADED_BANK_CHECK_URL', 'Sales Field: Uploaded Bank Check URL'],
    ['FEAT_SALES_FIELD_MISC_DOCUMENT_UPLOAD', 'Sales Field: Misc Document Upload'],
    ['FEAT_SALES_FIELD_UPLOADED_MISC_DOCUMENT_URL', 'Sales Field: Uploaded Misc Document URL'],
    ['FEAT_SALES_FIELD_REMARKS', 'Sales Field: Remarks'],
    ['FEAT_SALES_FIELD_FINANCED_AMOUNT', 'Sales Field: Financed Amount'],
    ['FEAT_SALES_FIELD_INSTALLMENT_MONTHS', 'Sales Field: Installment Months'],
    ['FEAT_SALES_FIELD_FIRST_DUE_DATE', 'Sales Field: First Due Date'],
];
...
const FEATURE_DEFINITIONS = [
    ...
    ['FEAT_SALES_UPDATE', 'Sales: Update Sale Button'],
    ...
    ['FEAT_STOCK_RECEIVE', 'Stock: Receive Stock Button'],
    ['FEAT_STOCK_UPDATE', 'Stock: Update Stock Button'],
    ['FEAT_STOCK_DELETE', 'Stock: Delete Stock Button'],
...
['FEAT_CUSTOMER_OCR_FIELDS', 'Customers: OCR Text Fields'],
['FEAT_CUSTOMER_OCR_PROCESS', 'Customers: Process OCR Button'],
['FEAT_CUSTOMER_FINGERPRINT_FIELDS', 'Customers: Fingerprint Text Fields'],
['FEAT_CUSTOMER_FINGERPRINT_SCAN', 'Customers: Scan Thumb Button'],
