...
import DashboardPageContent from './dashboardPages/DashboardPageContent';
...
const selectedCustomer = useMemo(
    ...
    const transactionSales = useMemo(
        () => [...dashboardData.salesTransactions].sort((a, b) => new Date(b.purchase_date || b.created_at || 0) - new Date(a.purchase_date || a.created_at || 0)),
        [dashboardData.salesTransactions]
    );
    ...
    const renderContent = () => <DashboardPageContent ctx={pageContentContext} />;
