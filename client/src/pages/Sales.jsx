                        ...
                        <div className="customers-grid">
                            ...
                            <form className="table-card customer-form-card" onSubmit={handleSaleSubmit}>
                                ...
                                <div className="form-grid">
                                    ...
                                    {canViewSalesUrlFields && canEditSalesField('Uploaded Agreement URL') ? <label className="field full-span"><span>Uploaded Agreement URL</span><input name="agreement_pdf_url" value={saleForm.agreement_pdf_url || ''} onChange={handleSaleChange} readOnly={uploadingAgreement} /></label> : null}
                                    ...
                                    {canViewSalesUrlFields && canEditSalesField('Dealer Signature URL') ? <label className="field full-span"><span>Dealer Signature URL</span><input name="dealer_signature_url" value={saleForm.dealer_signature_url || currentSalesDealerSignatureUrl || ''} onChange={handleSaleChange} readOnly /></label> : null}
                                    ...
                                    {canViewSalesUrlFields && canEditSalesField('Authorized Signature URL') ? <label className="field full-span"><span>Authorized Signature URL</span><input name="authorized_signature_url" value={saleForm.authorized_signature_url || ''} onChange={handleSaleChange} readOnly={uploadingSaleAuthorizedSignature} /></label> : null}
                                    ...
                                    {canViewSalesUrlFields && canEditSalesField('Customer CNIC Front URL') ? <label className="field full-span"><span>Customer CNIC Front URL</span><input name="customer_cnic_front_url" value={saleCustomerCnicFrontUrl || ''} readOnly /></label> : null}
                                    ...
                                    {canViewSalesUrlFields && canEditSalesField('Customer CNIC Back URL') ? <label className="field full-span"><span>Customer CNIC Back URL</span><input name="customer_cnic_back_url" value={saleCustomerCnicBackUrl || ''} readOnly /></label> : null}
                                    ...
                                    {canViewSalesUrlFields && canEditSalesField('Uploaded Bank Check URL') ? <label className="field full-span"><span>Uploaded Bank Check URL</span><input name="bank_check_url" value={saleForm.bank_check_url || ''} onChange={handleSaleChange} readOnly={uploadingSaleBankCheck} /></label> : null}
                                    ...
                                    {canViewSalesUrlFields && canEditSalesField('Uploaded Misc Document URL') ? <label className="field full-span"><span>Uploaded Misc Document URL</span><input name="misc_document_url" value={saleForm.misc_document_url || ''} onChange={handleSaleChange} readOnly={uploadingSaleMiscDocument} /></label> : null}
